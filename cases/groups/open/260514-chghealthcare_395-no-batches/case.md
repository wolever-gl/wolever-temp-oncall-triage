...
- Checks: 174.
- States: `blocked`=4, `healthy_closed`=170
- Blockers seen: `failed_export_count`

Check evidence:
- chk_q064v2c56cntcr_q01q2gj9ws4qwx (Q064V2C56CNTCR/Q01Q2GJ9WS4QWX): state=`healthy_closed`.
...
- chk_q064v2c56cntcr_q01realy7pgfux (Q064V2C56CNTCR/Q01REALY7PGFUX): state=`healthy_closed`.
...
- chk_q064v2c56cntcr_q024wdwuq24e10 (Q064V2C56CNTCR/Q024WDWUQ24E10): state=`healthy_closed`.
...
- chk_q064v2c56cntcr_q02o1u4aoth9fg (Q064V2C56CNTCR/Q02O1U4AOTH9FG): state=`healthy_closed`.
...
- chk_q064v2c56cntcr_q032369n84snwe (Q064V2C56CNTCR/Q032369N84SNWE): state=`healthy_closed`.
...
- chk_q064v2c56cntcr_q038efz7htakip (Q064V2C56CNTCR/Q038EFZ7HTAKIP): state=`healthy_closed`.
...
- chk_q064v2c56cntcr_q04j7tfoue7x0j (Q064V2C56CNTCR/Q04J7TFOUE7X0J): state=`healthy_closed`.
...
- chk_q064v2c56cntcr_q04jzbnjrdzjer (Q064V2C56CNTCR/Q04JZBNJRDZJER): state=`healthy_closed`.
...
- chk_q064v2c56cntcr_q04qppo67t1tme (Q064V2C56CNTCR/Q04QPPO67T1TME): state=`healthy_closed`.
...
- chk_q064v2c56cntcr_q04tizn9dlevz2 (Q064V2C56CNTCR/Q04TIZN9DLEVZ2): state=`healthy_closed`.
