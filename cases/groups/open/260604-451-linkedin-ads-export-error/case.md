...
Check evidence:
- chk_q3h4v02msu117k_q0pduewcnjaowx (Q3H4V02MSU117K/Q0PDUEWCNJAOWX): state=`blocked`.
  Scope: env=prod; org=451; audience=26037; endpoint=app_linkedin_ads_1600; destination=linkedin_ads.
  Checked runs: `26037-linkedin_ads_16093-scheduled__2026-06-04T00:00:00+00:00`
  Command: `glcli --env prod bifrost pizza --audience-id 26037 --org-id 451`
  Blockers: `missing_pizza_row`
  Run 26037-linkedin_ads_16093-scheduled__2026-06-04T00:00:00+00:00: health=`missing`; blockers=missing_pizza_row.
- chk_q3h4v02msu117k_q3cfjfcva0n716 (Q3H4V02MSU117K/Q3CFJFCVA0N716): state=`blocked`.
  Scope: env=prod; org=451; audience=25884; endpoint=app_linkedin_ads_1600; destination=linkedin_ads.
  Checked runs: `25884-linkedin_ads_16092-scheduled__2026-06-04T00:00:00+00:00`
  Command: `glcli --env prod bifrost pizza --audience-id 25884 --org-id 451`
  Blockers: `missing_pizza_row`
  Run 25884-linkedin_ads_16092-scheduled__2026-06-04T00:00:00+00:00: health=`missing`; blockers=missing_pizza_row.
