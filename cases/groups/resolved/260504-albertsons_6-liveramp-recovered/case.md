...
# Albertsons LiveRamp exports recovered
...
Exports with prior LiveRamp failures have later healthy checked runs.
...
- Exports with prior LiveRamp failures have later healthy checked runs.
  Source: `oncall-triage`; kind: `tag_grouping`; captured: `2026-05-16T01:48:36.487Z`.
