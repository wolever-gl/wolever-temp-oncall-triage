...
# albertsons_6 recovered after export failure

> Generated file. Do not edit directly; put free-form investigation notes in `notes.md`.

State: `resolved`
Tags: `resolved:later-export-succeeded`, `triage:tag_grouped`
Incidents: [Q2T09VCLN9MRZ8](https://growthloop.pagerduty.com/incidents/Q2T09VCLN9MRZ8), [Q38JR11G2ENK2W](https://growthloop.pagerduty.com/incidents/Q38JR11G2ENK2W)
Alerts: 140

## Current Summary

Albertsons audience failures where the failed LiveRamp export has later healthy export evidence.

## Alert Scope

- Alert facts: 140 imported, 140 linked to this group.
- Orgs: `albertsons_6`
- Audiences: `10114`, `10115`, `10159`, `10160`, `10161`, `10162`, `10163`, `10371`, and 132 more
- Destinations: `live_ramp_activation`
- State tuples: `snapshotting_finished/export_error`
- Commands seen: `glcli --env albertsons bifrost pizza --audience-id 10114 --org-id 6`, `glcli --env albertsons bifrost pizza --audience-id 10115 --org-id 6`, `glcli --env albertsons bifrost pizza --audience-id 10159 --org-id 6`, and 137 more
...
- Showing 10 of 140 alert facts; see `indexes/alert_facts.json` for the full imported set.
...
- chk_q2t09vcln9mrz8_q0ei1r5vdv4n0h (Q2T09VCLN9MRZ8/Q0EI1R5VDV4N0H): state=`blocked`.
  Scope: env=albertsons; org=6; audience=2996; endpoint=app_liveramp_activation_26; destination=live_ramp_activation.
  Checked runs: `2996-live_ramp_activation_1054-scheduled__2026-05-06T00:00:00+00:00`, `2996-live_ramp_activation_1054-manual__2026-05-06T18:09:59+00:00`
  Command: `glcli --env albertsons bifrost pizza --audience-id 2996 --org-id 6`
  Blockers: `failed_export_count`, `export_error`
  Run 2996-live_ramp_activation_1054-scheduled__2026-05-06T00:00:00+00:00: health=`blocked`; blockers=failed_export_count, export_error; created=2026-05-06T02:10:27.471554+00:00; snapshotting=snapshotting_finished; export=export_error; failed=41264.
  Run 2996-live_ramp_activation_1054-manual__2026-05-06T18:09:59+00:00: health=`healthy`; created=2026-05-06T19:07:23.526159+00:00; snapshotting=snapshotting_finished; export=export_finished; failed=0.
- Showing 10 of 140 checks; see `indexes/checks.json` and `checks/*/check.json` for the full evidence set.

## Recent Evidence

- Albertsons audience failures where the failed LiveRamp export has later healthy export evidence.
  Source: `oncall-triage`; kind: `tag_grouping`; captured: `2026-05-18T22:09:37.103Z`.
