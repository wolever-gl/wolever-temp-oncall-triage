...
State: `resolved`
Tags: `triage:needs_review`, `monitoring:export-processing`, `resolved:merged`
Incidents: [Q2T09VCLN9MRZ8](https://growthloop.pagerduty.com/incidents/Q2T09VCLN9MRZ8)
Alerts: 1

## Current Summary

Merged into 260511-albertsons_6-albertsons-6-export-in-progress: Duplicate Albertsons export-processing workspace after refreshed deterministic grouping; alert Q2T09VCLN9MRZ8/Q06RN07M3BVDQB is already tracked in the monitoring export-in-progress group with current preflight state=monitoring.
...
- Auto-monitored from Pizza export checks: 1 alert-scoped export check(s) are still processing and 0 are already healthy.
  Source: `check-exports`; kind: `export_check`; captured: `2026-06-22T15:06:55.764Z`.

## Next Action

Follow target group 260511-albertsons_6-albertsons-6-export-in-progress.
