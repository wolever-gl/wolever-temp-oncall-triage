...
Incidents: [Q0BSIBMDIB33PB](https://growthloop.pagerduty.com/incidents/Q0BSIBMDIB33PB)
Alerts: 1

## Current Summary

Merged into 260622-albertsons_6-quervice-timeouts: Audience 1972 is in the Quervice pre-snapshotting timeout/error-response cohort.
...
- Commands seen: `glcli --env albertsons bifrost pizza --audience-id 1972 --org-id 6`
