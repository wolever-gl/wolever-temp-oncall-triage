...
State: `resolved`
Tags: `triage:albertsons-client-sent`, `triage:needs_evidence`, `triage:tag_grouped`, `resolved:merged`
...
Merged into 260622-albertsons_6-quervice-timeouts: Unknown/blank snapshotting failures were classified by scoped logs as Quervice timeout, 503, or lock-expiry behavior; track them with the Quervice timeout remediation case.
